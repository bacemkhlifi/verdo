                ...
                <div class="flex justify-between h-16 items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-lg font-semibold text-gray-900 hidden sm:block">{{ $t('admin.nav.panelTitle') }}</span>
                            <span class="text-lg font-semibold text-gray-900 sm:hidden">{{ $t('admin.nav.panelShortTitle') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-2 sm:space-x-4">
                        ...
                        <span class="text-sm text-gray-500 hidden md:block">{{ $t('admin.nav.welcome', { name: adminName }) }}</span>
                        ...
                        <router-link to="/"
                            ...
                            <span class="hidden sm:block">{{ $t('admin.nav.backToWebsite') }}</span>
                            <span class="sm:hidden">{{ $t('admin.nav.back') }}</span>
                        </router-link>
                        ...
                        <button @click="handleLogout"
                            ...
                            <span class="hidden sm:block">{{ $t('admin.nav.logout') }}</span>
                            <span class="sm:hidden">{{ $t('admin.nav.logoutShort') }}</span>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col w-64 bg-white border-r border-gray-200 shadow-sm">
                    <div class="h-16 flex items-center px-6 border-b border-gray-200">
                        <div class="flex items-center">
                            ...
                            <span class="text-lg font-bold text-gray-900">{{ $t('admin.nav.brandTitle') }}</span>
                        </div>
                    </div>
                    <div class="flex-1 flex flex-col overflow-y-auto pt-6 pb-4">
                        <nav class="mt-2 flex-1 px-3 space-y-2">
                            ...
                            <router-link to="/admin/lands"
                                class="group flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-all duration-200"
                                :class="[$route.path.includes('/admin/lands') ? 'bg-green-100 text-green-800 shadow-sm' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900']">
                                <svg class="mr-3 h-6 w-6"
                                    :class="[$route.path.includes('/admin/lands') ? 'text-green-600' : 'text-gray-400 group-hover:text-gray-600']"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white shadow-xl">
                    ...
                    <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                        <div class="flex-shrink-0 flex items-center px-4 mb-6">
                            <img src="../assets/olive.png" alt="Logo" class="h-8 w-8 mr-3">
                            <span class="text-xl font-bold text-gray-900">{{ $t('admin.nav.brandTitle') }}</span>
                        </div>
